"""Maintenance AI triage agent - ported verbatim from teammate
feature-lavanya's branch (Design Contract section 20).

Stopping condition: classify the ticket, choose a vendor queue, set
escalation when required, then return the result once. This module never
loops or retries on its own - the caller (service layer) applies the
result and stops.
"""
